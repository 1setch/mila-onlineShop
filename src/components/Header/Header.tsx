        ...
        <div className="container">
          <div className={styles.inner}>
            ...
            <div className={styles.logo}>
              ...
              >
                <g clip-path="url(#clip0_2022_2823)">
                  <path
            ...
            <div className={styles.actions}>
              ...
              <Button variant="ghost">
                ...
                <path d="M19.3164 33C26.9103 33 33.0664 26.8439 33.0664 19.25C33.0664 11.6561 26.9103 5.5 19.3164 5.5C11.7225 5.5 5.56641 11.6561 5.56641 19.25C5.56641 26.8439 11.7225 33 19.3164 33Z" stroke="#212121" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="round"/>
                <path d="M29.0391 28.9727L38.5661 38.4997" stroke="#212121" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="round"/>
                </svg>
              </Button>
              <Button variant="ghost">
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M22.4956 32.196C21.385 32.196 20.4983 31.8693 19.8356 31.216C19.1823 30.5533 18.8556 29.564 18.8556 28.248V25.952C18.8556 24.6453 19.1823 23.6607 19.8356 22.998C20.4983 22.3353 21.385 22.004 22.4956 22.004C23.6156 22.004 24.5023 22.3353 25.1556 22.998C25.8183 23.6607 26.1496 24.6453 26.1496 25.952V28.248C26.1496 29.564 25.8183 30.5533 25.1556 31.216C24.5023 31.8693 23.6156 32.196 22.4956 32.196ZM22.4956 31.174C23.3356 31.174 23.9656 30.922 24.3856 30.418C24.8056 29.914 25.0156 29.2093 25.0156 28.304V25.882C25.0156 24.9767 24.801 24.2767 24.3716 23.782C23.9423 23.278 23.317 23.026 22.4956 23.026C21.6743 23.026 21.049 23.278 20.6196 23.782C20.1996 24.286 19.9896 24.986 19.9896 25.882V28.304C19.9896 29.2187 20.1996 29.928 20.6196 30.432C21.0396 30.9267 21.665 31.174 22.4956 31.174Z" fill="#212121"/>
                </svg>
              </Button>
            </div>
          </div>
